...
public class LockManager {
    ...
    public synchronized void releaseLocks(Object client) {
        releaseLocks(client, lockedDirectors);
        releaseLocks(client, lockedFilms);
    }

    private void releaseLocks(Object client, Map<Number, Lock> locks) {
